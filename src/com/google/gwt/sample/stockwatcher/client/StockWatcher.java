...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher() {
		...
		newSymbolTextBox.setFocus(true);// Listen for mouse events on the Add button.
	...
	private void addStock() {
		...
		//!!! TODO check to make sure i didn't need this
	...
	// !!! TODO 
	// THIS IS WHERE STOCK PRICE DATA COMES FROM
